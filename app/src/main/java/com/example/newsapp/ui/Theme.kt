...
private val DarkColorScheme = darkColorScheme(
    ...
    onPrimary = bg_on_primary_dark,
    secondary = bg_secondary_dark,
    tertiary = bg_tertiary_dark,
    onTertiary = bg_on_tertiary_dark,
